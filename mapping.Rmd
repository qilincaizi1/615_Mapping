...
RES <- read.csv("D:/school material/615 hw/mapping/mayorsfoodcourt.csv",na.strings=c("","NA"))
```
...
# require(ggmap)
# 
# map.center <- geocode("Boston,MA", output = c("latlon", "latlona", "more", "all"), source = c("google", "dsk"), messaging = FALSE, force = ifelse(source == "dsk", FALSE, TRUE), sensor = FALSE, override_limit = FALSE)
# 
